 ...
 *
 * Daily wisdom from Proverbs or Psalms with verse rotation.
 *
 * Features:
 * - Segmented control to switch between Proverbs and Psalms
 * - Day-of-year based initial verse selection
 ...
 *
 * Data Structure:
 * - PROVERBS_LIBRARY: { "Reference": "Verse text..." }
 * - PSALMS_LIBRARY: { "Reference": "Verse text..." }
 */

import React, { useState } from 'react';
import * as Icons from '../shared/Icons';

// Embedded Proverbs library
const PROVERBS_LIBRARY = {
...
// Embedded Psalms library
const PSALMS_LIBRARY = {
...
const DailyWisdomCard = ({ onHelpClick }) => {
  const [mode, setMode] = useState('proverbs'); // 'proverbs' or 'psalms'
  ...
  // Cycle through verses: start with day-of-year, then allow manual cycling
  ...
  return (
    <div className="card wisdom-card">
      <div className="card-header gold has-dots">
        <h3>
          <span className="card-icon card-icon-ochre">
            <Icons.BookSolid />
          </span>
          Daily Wisdom
        </h3>
      ...
      <div className="card-content">
        ...
        <div className="wisdom-verse-block">
          ...
          {verseText ? (
            <div className="wisdom-text" style={{ whiteSpace: 'pre-line' }}>
              {verseText}
            </div>
          ) : null}
        </div>
